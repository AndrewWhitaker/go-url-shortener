...
func (suite *getSuite) BeforeTest(suiteName, testName string) {
	TestContext.BeforeTest()
}

func (suite *getSuite) TestGetWithValidShortUrlReturns200() {
	t := suite.T()
	...
	testAPI.Get(fmt.Sprintf("/api/v1/shorturls/%s", slug)).
